...
uint8_t *sha256_hmac(uint8_t *key, size_t key_length, uint8_t *message, size_t message_length)
{
	...
	memcpy(key_opad_H_key_ipad_message, H_key_ipad_message, B / 2);
